      ...
      <div className='bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-[90vw] max-w-4xl max-h-[80vh] flex flex-col overflow-hidden border border-gray-200 dark:border-gray-700'>
        ...
        <div className='flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <button
              onClick={onClose}
              className='shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-700 transition-colors'
            >
              <svg
                className='w-5 h-5'
                fill='none'
            ...
            <div className='flex items-center gap-3'>
              ...
              <div className='flex-1'>
                <div className='flex items-center gap-2'>
                  ...
                  {offlineMode && (
                    <span className='px-2 py-0.5 text-xs font-medium bg-blue-500 text-white rounded-sm'>
                      已启用
                    </span>
                  )}
                </div>
        ...
        {pageCount > 1 && (
          <div className='flex items-center gap-4 px-6 py-3 border-b border-gray-200 dark:border-gray-700'>
            ...
            {/* 向上/向下按钮 */}
            <button
              className='shrink-0 w-8 h-8 rounded-md flex items-center justify-center text-gray-700 hover:text-green-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:text-green-400 dark:hover:bg-gray-700 transition-colors'
