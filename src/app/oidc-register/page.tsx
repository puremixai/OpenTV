...
function OIDCRegisterPageClient() {
  ...
  return (
    <div className='cinema-auth relative min-h-screen flex items-center justify-center px-4 overflow-hidden'>
      ...
      <div className='cinema-auth-card relative z-10 w-full max-w-md rounded-3xl bg-linear-to-b from-white/90 via-white/70 to-white/40 dark:from-zinc-900/90 dark:via-zinc-900/70 dark:to-zinc-900/40 backdrop-blur-xl shadow-2xl p-10 dark:border dark:border-zinc-800'>
