...
// 从环境变量获取站点名称
const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'OpenTV';
...
const manifestTemplate = {
  ...
  icons: [
    {
      src: '/icons/icon-192x192.png?v=opentv',
      sizes: '192x192',
      type: 'image/png',
    },
    {
      src: '/icons/icon-256x256.png?v=opentv',
      sizes: '256x256',
      type: 'image/png',
    },
    {
      src: '/icons/icon-384x384.png?v=opentv',
      sizes: '384x384',
      type: 'image/png',
    },
    {
      src: '/icons/icon-512x512.png?v=opentv',
      sizes: '512x512',
      type: 'image/png',
    },
  ],
